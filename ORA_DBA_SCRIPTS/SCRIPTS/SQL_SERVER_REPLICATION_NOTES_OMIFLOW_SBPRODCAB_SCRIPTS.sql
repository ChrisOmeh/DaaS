...
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NTNIGE\A250089'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NTNIGE\EA250089T1'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NTNIGE\EA246458T1'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NTNIGE\A246458'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NTNIGE\SQLCluster'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NT SERVICE\Winmgmt'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NT SERVICE\SQLWriter'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NT SERVICE\SQLSERVERAGENT'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'NT SERVICE\MSSQLSERVER'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'alwayson'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'newgenadmin'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'attunity'
GO
exec sp_grant_publication_access @publication = N'AR_PUBLICATION_00005', @login = N'distributor_admin'
GO
